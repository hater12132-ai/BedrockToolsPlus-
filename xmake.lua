...
target("BedrockToolsPlus")
    ...
    after_build(function (target)
        ...
        assert(python, "Python 3 is required to package BedrockToolsPlus.levipack")
        ...
        table.insert(args, path.join(os.projectdir(), "assets", "bedrocktoolsplus.png"))
        ...
        table.insert(args, path.join(target:targetdir(), "BedrockToolsPlus.levipack"))
